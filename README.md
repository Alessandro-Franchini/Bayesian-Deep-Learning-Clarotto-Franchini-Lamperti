...
In _Regression Study_ folder you will find the following codes: 
...
In _Qlearning_ folder you will find the following codes:
...
* [post_prod](https://github.com/Alessandro-Franchini/Bayesian-Deep-Learning-Clarotto-Franchini-Lamperti/blob/master/Project/Qlearning/post_prod.py) - where you will find post production.
