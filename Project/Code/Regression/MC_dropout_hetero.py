...
plt.plot(x_train.numpy(),y_train.cpu().numpy(),'.',markersize=30, label='x train')
plt.plot(x_val.numpy(),y_val.cpu().numpy(),'.',markersize=10, label='x test')
...
#plt.savefig('MC_dropout_hetero_no_var.pdf', bbox_inches = 'tight')
plt.savefig('MC_dropout_hetero_outliers_p.pdf', bbox_inches = 'tight')
plt.show()
