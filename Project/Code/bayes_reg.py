...
x4=torch.linspace(-4,4,n_outliers).view(-1,1)
...
plt.plot(x_val.cpu().numpy(),y_val.cpu().numpy(),'lime','-',linewidth=2,alpha=0.6)
...
plt.ylim([-2,5])
plt.xlim([-6.5,6.5])
plt.title('Bayesian Neural Network with Outliers')
